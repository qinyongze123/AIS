...
"QTabWidget::pane { border: 1px solid #ddd; top: -1px; background: white; border-radius: 4px; }")
        ...
        self.label_safe_hint.setVisible(True) # Hidden by default if starting in Work, but we start in Safe
        self.controlMainVBox.addWidget(self.label_safe_hint)
        ...
        self.widget_operation.setVisible(False) # Hidden by default since we start in Safe
